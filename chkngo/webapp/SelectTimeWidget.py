#SelectTimeWidget from :https://www.djangosnippets.org/snippets/1202/
#Documentation on : https://bradmontgomery.net/blog/selecttimewidget-a-custom-django-widget/ 
